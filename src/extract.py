...
7. Промо-акции — ТОЛЬКО про торговый и интернет-эквайринг. Вклады, кредиты,
   зарплатные проекты, кобрендовые карты игнорируй. Предложения про оплату
   по QR-коду и СБП тоже не бери: их ставки кратно ниже эквайринговых, и в
   сравнении они создают ложную картину.
